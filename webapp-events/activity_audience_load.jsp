<%@ page import="java.net.URLDecoder,java.util.ListIterator,java.io.IOException,java.net.URLDecoder,com.knowgate.acl.ACL,com.knowgate.workareas.WorkArea,com.knowgate.debug.DebugFile,com.knowgate.debug.StackTraceUtil,com.knowgate.dataobjs.DB,com.knowgate.dataobjs.DBBind,com.knowgate.dataobjs.DBAudit,com.knowgate.dataobjs.DBColumn,com.knowgate.dataobjs.DBCommand,com.knowgate.jdc.JDCConnection,com.knowgate.misc.Gadgets,com.knowgate.hipergate.Address,com.knowgate.crm.Contact,com.knowgate.marketing.ActivityAudience,com.knowgate.marketing.ActivityAudienceLoader,com.knowgate.crm.DistributionList,com.knowgate.hipermail.SendMail" language="java" session="false" contentType="text/plain;charset=UTF-8" %><%@ include file="methods/dbbind.jsp" %><%@ include file="methods/clientip.jspf" %><% 
  ...
  int iFlags = ActivityAudienceLoader.MODE_APPENDUPDATE|ActivityAudienceLoader.WRITE_CONTACTS|ActivityAudienceLoader.WRITE_ADDRESSES;
  ...
  try {
    oConn = GlobalDBBind.getConnection(PAGE_NAME);
		...
		short iAuth = ACL.autenticate(oConn, gu_writer, tx_pwd, ACL.PWD_CLEAR_TEXT);
    ...
    oLodr.storeLine(oConn, gu_workarea, iFlags, tx_colnames, tx_coldelimiter, Gadgets.join(aColValues,request.getParameter("tx_coldelimiter")));
    ...
    oConn=null;
    out.write("ERROR for User "+gu_writer+" at WorkArea = "+gu_workarea+" "+e.getClass().getName()+" "+e.getMessage()+" "+StackTraceUtil.getStackTrace(e));
    if (DebugFile.trace) {
